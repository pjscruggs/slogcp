...
([`out_google_cloud.rb`](https://github.com/GoogleCloudPlatform/fluent-plugin-google-cloud/blob/master/lib/fluent/plugin/out_google_cloud.rb)),
and are refined using direct observations of backend field-handling behavior. It
is a focused best-effort model of this parsing/elevation stage, not a full
