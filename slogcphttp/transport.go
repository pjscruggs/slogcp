...
func (t roundTripper) handleNilRequest() (*stdhttp.Response, error) {
...
func (t roundTripper) buildAttrs(ctx context.Context, req *stdhttp.Request, scope *RequestScope) []slog.Attr {
...
func (t roundTripper) applyEnrichers(attrs []slog.Attr, req *stdhttp.Request, scope *RequestScope) []slog.Attr {
...
func (t roundTripper) applyTransformers(attrs []slog.Attr, req *stdhttp.Request, scope *RequestScope) []slog.Attr {
...
func (t roundTripper) finishRoundTrip(req *stdhttp.Request, scope *RequestScope) (*stdhttp.Response, error) {
